...
tcrs2 <- read.csv("PLUS_teacher_survey_variables_studentlevel.csv")
head(tcrs2)

# Process data
# Sort by student id, drop duplicates
tcrs2 %>% 
  arrange(stud_id) %>%
...
# Drop unnecessary "child_num" variable
tcrs[ , "child_num"] <- NULL
...
names(tcrs)[names(tcrs)=="brief_1r"] <- "brief_wm_1"
names(tcrs)[names(tcrs)=="brief_4r"] <- "brief_wm_2"
names(tcrs)[names(tcrs)=="brief_7r"] <- "brief_wm_3"
names(tcrs)[names(tcrs)=="brief_10r"] <- "brief_wm_4"
names(tcrs)[names(tcrs)=="brief_2r"] <- "brief_cf_1"
names(tcrs)[names(tcrs)=="brief_3r"] <- "brief_cf_2"
names(tcrs)[names(tcrs)=="brief_6r"] <- "brief_cf_3"
names(tcrs)[names(tcrs)=="brief_9r"] <- "brief_cf_4"
names(tcrs)[names(tcrs)=="brief_5r"] <- "brief_ec_1"
names(tcrs)[names(tcrs)=="brief_8r"] <- "brief_ec_2"
names(tcrs)[names(tcrs)=="brief_11r"] <- "brief_ec_3"
names(tcrs)[names(tcrs)=="brief_12r"] <- "brief_ec_4"

# Make composite data frame with Hightower + BRIEF items of interest
hybrid_vars <- c("tcrs_ao2r", "tcrs_to3", "brief_wm_2", "brief_cf_1")
...
hybrid[ , "ef4"] <- as.numeric(rowMeans(hybrid[ , paste0(hybrid_vars, "_z")], na.rm=TRUE))
head(hybrid)
...
desc(hybrid[ , c(hybrid_vars, paste0(hybrid_vars, "_z"), "ef4")], c(mean, sd, skewness, kurtosis, min, max))
